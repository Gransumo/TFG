...
router.get('/invitations', authenticateToken, invitationController.getMyInvitations);
router.get('/events/:eventId/invitations', authenticateToken, invitationController.getInvitations);
